document.addEventListener('DOMContentLoaded', function () {
    const examSchedule = [
        { subject: 'TOC', preBoardDate: 'February 28, 2024', boardDate: 'March 19, 2024', chapters: 7 },
        { subject: 'CN', preBoardDate: 'March 1, 2024', boardDate: 'March 22, 2024', chapters: 7 },
        { subject: 'OS', preBoardDate: 'March 3, 2024', boardDate: 'March 26, 2024', chapters: 7 },
        { subject: 'DBMS', preBoardDate: 'March 5, 2024', boardDate: 'March 29, 2024', chapters: 10 },
        { subject: 'AI', preBoardDate: 'March 7, 2024', boardDate: 'April 1, 2024', chapters: 6 }
    ];

    function calculateRemainingDays(examDate, examType) {
        let examDateTime;
        if (examType === 'preBoard') {
            examDateTime = new Date('February 26, 2024');
        } else {
